...
public class DBUtils {
    ...
    public static Integer update(String sql,Object ... paramter) throws Exception{
        conn = getConnection();
        // prepareStatement可以用?号作为参数占位符，从1开始编号
        // INSERT INTO T_USER(user_name,real_name,password,age,d_id)values(?,?,?,?,?)
        // 上面的?有5个，每个从1~5开始编号，通过for循环将对应的参数映射进去
